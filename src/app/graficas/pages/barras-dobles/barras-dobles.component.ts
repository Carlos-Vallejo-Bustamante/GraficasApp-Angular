...
export class BarrasDoblesComponent {
  ...
  proveedoresData: ChartData<'bar'> = {
    ...
    datasets: [
      { data: [100, 200, 300, 400, 500], label: 'Vendedor A', indexAxis: 'x' },
      { data: [50, 250, 30, 450, 200], label: 'Vendedor B', indexAxis: 'x' }
    ]
  };
  ...
  productoData: ChartData<'bar'> = {
    labels: this.proveedoresLabels,
    datasets: [
      { data: [200, 300, 400, 300, 100], label: 'Carros', backgroundColor: 'blue', indexAxis: 'x' },
    ]
  };
